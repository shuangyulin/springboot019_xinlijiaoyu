          ...
          <el-form-item class="input" label="身份证号" prop="shenfenzhenghao">
              <el-input v-model="ruleForm.shenfenzhenghao" 
                placeholder="身份证号" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="心理问题备注" prop="xinliwentibeizhu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="心理问题备注"
                  v-model="ruleForm.xinliwentibeizhu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xinliwentibeizhu" label="心理问题备注" prop="xinliwentibeizhu">
                    <span>{{ruleForm.xinliwentibeizhu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shenfenzhenghao = true;
            continue;
	            	            ...
	            	            if(o=='xinliwentibeizhu'){
            this.ruleForm.xinliwentibeizhu = obj[o];
	    this.ro.xinliwentibeizhu = true;
            continue;
          }
	                    }
                                                                                                              }
